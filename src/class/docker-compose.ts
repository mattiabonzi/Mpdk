...
export default class MoodleDockerClient extends DockerClient{
      ...
      public cmd(cmd:string, log=true) {
        ...
        var compose = `compose --ansi never --env-file ${envfile} -f ../mpdk-assets/base.yml`;
        var env:any = {
        ...
        if (this.mpdk.proxy) {
            ...
            compose += ' -f ../mpdk-assets/proxy.yml';
        } else {
            var host = "127.0.0.1:";
       ...
       env['COMPOSE_PROJECT_NAME'] = this.mpdk.instance.name; 
        ...
        compose += ' -f ../mpdk-assets/dbpassword.yml ';
